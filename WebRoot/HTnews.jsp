...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
			...
			<div class="mem_t">
            	<span class="m_num fr" style="margin-top:15px;"><a href="NewsListServlet">返回</a></span>咨询列表
            </div>
       ...
       <table border="1" class="mem_tab" style="width:870px; text-align:center; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${listn }" var="new">
              	
              	 <tr>
              	  	<td width="290" colspan="2">${new.id }</td>  
	                <td width="290" class="td_bg" colspan="2">${new.title }</td>
	                 <td width="290" colspan="2">${new.content }</td>  
	                <td width="290" colspan="2">${new.createTime }</td>  
	                <%--  <td width="145"><a href="NewsListServlet?action=addNews&id=${new.id }">修改</a></td>  
	                  <td width="145"><a href="NewsListServlet?action=delete&id=${new.id }">删除</a></td>  --%> 
           	  	 </tr>    
