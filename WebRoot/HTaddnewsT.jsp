	...
	<div class="m_content">
   	<%@ include file="include/HTleftM.jsp" %>
		...
		<div class="m_right">
           ...
           <form id="add" action="NewsListServlet?action=add" method="post" />
       	 
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr height="70">
                <td>标&nbsp; &nbsp; 题:</td>
                <td><input type="text" value="" id="title" name="title" style="width:300px;height:30px" /></td>
              </tr>
              <tr height="70">
                <td>内&nbsp; &nbsp; 容:</td>&nbsp; &nbsp;
                <td><textarea name="content" id="content" value="" style="width:300px;height:50px"></textarea></td>
              </tr> 
              
                         
              <tr height="60">
              	<td>&nbsp;</td>
                <td><input type="submit" class="log_btn" value="添加"/></td>
              </tr>
            </table>
            </form>
        </div>
