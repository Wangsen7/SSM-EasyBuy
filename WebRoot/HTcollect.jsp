...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            <p></p>
            <div class="mem_tit">
            	<span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;">共发现${fn:length(collectProduct.list) }件</span>我的收藏
            </div>
              ...
              <c:forEach items="${collectProduct.list }" var="product" varStatus="status">
              	 <tr>
	                <td style="font-family:'宋体';">
	                	<div class="sm_img"><img src="${ctx }/files/${product.fileName }" width="48" height="48" /></div>${product.name }
	                </td>
	                <td align="center">￥${product.price }</td>
	                <td align="center"><a href="#">关注</a>&nbsp; &nbsp; <a href="javascript:addCar(${product.id },1)" style="color:#ff4e00;">加入购物车</a>&nbsp; &nbsp; <a href="CollectProductServlet?action=delete&index=${status.index }">删除</a></td>
              </tr>
              </c:forEach>
             <!--  <tr>
                <td style="font-family:'宋体';">
