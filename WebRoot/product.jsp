...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${ctx }/files/${product.fileName}" title="Images" class="MagicZoom" id="MagicZoom"><img src="${ctx }/files/${product.fileName}" width="390" height="390" /></a></div>
        ...
        <div class="pro_des">
        	<div class="des_name">
            	<p><!-- Dior/迪奥 真我香水EDP 克丽丝汀迪奥 全新 30ml -->${product.name }</p>
               
            </div>
            <div class="des_price">
            	本店价格：<b>￥<!-- 589 -->${product.price }</b><br />
            	<!-- 限制小数点个数 -->
                消费积分：<span><fmt:formatNumber type="number" value="${product.price/20 }" maxFractionDigits="0"></fmt:formatNumber>R</span>
            </div>
            ...
            <div class="des_join">
              ...
              <!--   <span class="fl"><a onclick="ShowDiv_1('MyDiv1','fade1')"><img src="images/j_car.png" /></a></span> -->
                <span class="fl"><a href="javascript:addCarInfo(${product.id })"><img src="images/j_car.png" /></a></span>
            </div>            
        </div>    
